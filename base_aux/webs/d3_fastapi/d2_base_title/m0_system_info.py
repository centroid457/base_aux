...
# FIXME
#   cache funcs as classmethod??
#   disc - mark used!
#   net - add UP/DOWN
#   add git! + python +path start
...
class SystemInfo:
    ...
    def _get_dynamic__cpu(self) -> dict[str, Any]:
        ...
        try:
            ...
            result["load_avg"] = {
                "load_1min": self.calc_gb(load_avg[0]),
                "load_5min": self.calc_gb(load_avg[1]),
                "load_15min": self.calc_gb(load_avg[2]),
            }
        except Exception as exc:
