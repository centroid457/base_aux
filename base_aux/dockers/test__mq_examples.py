...
class Test_RabbitMqExample:
    ...
    def test_queue_creation(self, rabbitmq_channel):
    ...
    def test_message_publish_consume(self, rabbitmq_channel):
    ...
    def test_multiple_messages(self, rabbitmq_channel):
    ...
    def test_exchanges_and_bindings(self, rabbitmq_channel):
    ...
    def test_consumer_with_callback(self, rabbitmq_channel):
